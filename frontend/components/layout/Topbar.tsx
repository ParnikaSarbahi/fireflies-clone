...
export default function Topbar() {
  ...
  const [
    ...
    setShowCapturePlaceholder,
  ] = useState(false);

  const [
    showNotificationsPlaceholder,
    setShowNotificationsPlaceholder,
  ] = useState(false);
  ...
  return (
    <>
      <header className="fixed left-[60px] right-0 top-0 z-30 flex h-[72px] items-center border-b border-[#292929] bg-[#171717] px-5">
        ...
        <div className="ml-auto flex items-center gap-4">
          ...
          <button
            type="button"
            onClick={() =>
              setShowCapturePlaceholder(true)
            }
          ...
          <button
            ...
            onClick={() =>
              setShowNotificationsPlaceholder(true)
            }
      ...
      {showCapturePlaceholder && (
        <ComingSoonModal
          feature="Capture Meeting"
          onClose={() =>
            setShowCapturePlaceholder(false)
          }
        />
      )}
      ...
      {showNotificationsPlaceholder && (
        <ComingSoonModal
          ...
          onClose={() =>
            setShowNotificationsPlaceholder(false)
          }
        />
      )}
    </>
